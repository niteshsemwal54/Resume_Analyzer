  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4 py-12">
      <div className="w-full max-w-md rounded-3xl border border-white/20 bg-slate-900/70 p-8 shadow-2xl backdrop-blur-xl">
        ...
        <p className="mt-2 text-sm text-slate-300">Sign in to analyze resumes with AI.</p>
        <form onSubmit={handleSubmit} className="mt-8 space-y-4">
          ...
          <button className="w-full rounded-2xl bg-blue-600 px-4 py-3 font-semibold transition hover:bg-blue-500" type="submit">Login</button>
        </form>
        <p className="mt-4 text-sm text-slate-400">Need an account? <Link className="text-blue-400" to="/register">Register</Link></p>
      </div>
    </div>
  );
}
